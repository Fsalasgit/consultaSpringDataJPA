...
public class Principal {
    ...
    private final String API_KEY = "&apikey=" + System.getenv("apideOMDB");
    ...
    public void muestraElMenu() {
        ...
        while (opcion != 0) {
            var menu = """
                    ...
                    7 - Filtrar por max temporadas y evaluacion
    ...
    private void filtrarSeriePorTemporadaYEvaluacion() {
        ...
        System.out.println("Indica el maximo numero de temporadas");
        var totalTemporadas = teclado.nextInt();
        teclado.nextLine();
        System.out.println("Indica evaluación minima");
    ...
    private void buscarTop5Episodios(){
        ...
        if (serieBuscada.isPresent()){
            ...
            topEpisodios.forEach(e -> System.out.printf("numero episodio: %s Temporada: %s Episodio: %s Evaluacion: %s\n",
                    e.getNumeroEpisodio(),e.getTemporada(), e.getTitulo(), e.getEvaluacion()));
        }
